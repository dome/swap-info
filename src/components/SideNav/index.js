      ...
      {!below1080 ? (
        <DesktopWrapper>
          ...
          <AutoColumn gap="0.5rem" style={{ marginLeft: '.75rem', marginBottom: '4rem' }}>
            <HeaderText>
              <Link href={`https://${process.env.REACT_APP_HOMEPAGE_URL}/`} target="_blank">
            ...
            <HeaderText>
              <Link href="https://discord.com/invite/mSEc2uv" target="_blank">
                Discord
              </Link>
            </HeaderText>
            <HeaderText>
              <Link href="https://twitter.com/SASHIMISASHIMI5" target="_blank">
                Twitter
              </Link>
            </HeaderText>
            */}
